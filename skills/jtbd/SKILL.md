...
name: jtbd
description: >
  Extracts Jobs to be Done statements from discovery artifacts. Challenges weak
  jobs until situations are specific, motivations are real (not disguised
  solutions), and outcomes are measurable. Outputs a prioritized set of jobs.
---
