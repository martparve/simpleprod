...
Follow the personality rules from the root CLAUDE.md. **Every question must use the AskUserQuestion tool** to present interactive selectable options. Never ask bare open-ended questions.
